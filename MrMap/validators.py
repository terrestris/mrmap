...
from service.helper.enums import OGCServiceEnum, DocumentEnum, MetadataEnum, PendingTaskEnum, SpatialResolutionTypesEnum
...
def validate_spatial_resolution_types_enum_choices(value):
    return validate_choice(value, SpatialResolutionTypesEnum.as_choices())
